...
public class NetworkCharacterControllerPrototypeCustom : NetworkTransform {
  ...
  public virtual void Move(Vector3 direction) {
    ...
    if (direction == default) {
      ...
      // This makes player unable to strafe
  ...
  /// <summary>
  /// Basic implementation of a character controller's rotation function based on an intended rotation.
  /// For now it only rotates on the Y axis (side to side).
  /// <param name="rotationY">Intended rotation on the Y axis, subject to rotation speed value.</param>
  /// </summary>
